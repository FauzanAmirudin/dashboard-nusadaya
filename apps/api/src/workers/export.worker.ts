	...
	try {
		...
		for (const file of files) {
			try {
				...
				// @ts-ignore - Readable.fromWeb takes Web Stream
				...
				console.error(`[ExportWorker] Gagal memasukkan file ${file.id} ke ZIP:`, err);
		...
		console.log(`[ExportWorker] Job ${jobId} completed ✅. Size: ${archive.pointer()} bytes`);
